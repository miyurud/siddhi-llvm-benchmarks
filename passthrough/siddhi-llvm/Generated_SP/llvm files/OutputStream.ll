; ModuleID = 'OutputStream.cpp'
source_filename = "OutputStream.cpp"
...
@.str.4 = private unnamed_addr constant [10 x i8] c"sumWeight\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_OutputStream.cpp, i8* null }]

@_ZN12OutputStreamC1Ev = alias void (%class.OutputStream*), void (%class.OutputStream*)* @_ZN12OutputStreamC2Ev
...
define void @_ZN12OutputStreamC2Ev(%class.OutputStream*) unnamed_addr #4 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = alloca %class.OutputStream*, align 8
  %3 = alloca i8*
  %4 = alloca i32
  store %class.OutputStream* %0, %class.OutputStream** %2, align 8
  %5 = load %class.OutputStream*, %class.OutputStream** %2, align 8
  %6 = getelementptr inbounds %class.OutputStream, %class.OutputStream* %5, i32 0, i32 0
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1Ev(%"class.std::__cxx11::basic_string"* %6) #3
  %7 = getelementptr inbounds %class.OutputStream, %class.OutputStream* %5, i32 0, i32 1
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1Ev(%"class.std::__cxx11::basic_string"* %7) #3
  %8 = getelementptr inbounds %class.OutputStream, %class.OutputStream* %5, i32 0, i32 0
...
; <label>:10:                                     ; preds = %1
  %11 = getelementptr inbounds %class.OutputStream, %class.OutputStream* %5, i32 0, i32 1
...
; Function Attrs: noinline optnone uwtable
define void @_ZN12OutputStream9getWeightB5cxx11Ev(%"class.std::__cxx11::basic_string"* noalias sret, %class.OutputStream*) #4 align 2 {
  %3 = alloca %class.OutputStream*, align 8
  store %class.OutputStream* %1, %class.OutputStream** %3, align 8
  %4 = load %class.OutputStream*, %class.OutputStream** %3, align 8
  %5 = getelementptr inbounds %class.OutputStream, %class.OutputStream* %4, i32 0, i32 0
...
; Function Attrs: noinline optnone uwtable
define void @_ZN12OutputStream9setWeightENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(%class.OutputStream*, %"class.std::__cxx11::basic_string"*) #4 align 2 {
  %3 = alloca %class.OutputStream*, align 8
  store %class.OutputStream* %0, %class.OutputStream** %3, align 8
  %4 = load %class.OutputStream*, %class.OutputStream** %3, align 8
  %5 = getelementptr inbounds %class.OutputStream, %class.OutputStream* %4, i32 0, i32 1
  ...
  %7 = getelementptr inbounds %class.OutputStream, %class.OutputStream* %4, i32 0, i32 0
  ...
  %11 = getelementptr inbounds %class.OutputStream, %class.OutputStream* %4, i32 0, i32 0
  ...
  %13 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %12, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  ret void
}
...
; Function Attrs: noinline optnone uwtable
define void @_ZN12OutputStream12getSumWeightB5cxx11Ev(%"class.std::__cxx11::basic_string"* noalias sret, %class.OutputStream*) #4 align 2 {
  %3 = alloca %class.OutputStream*, align 8
  store %class.OutputStream* %1, %class.OutputStream** %3, align 8
  %4 = load %class.OutputStream*, %class.OutputStream** %3, align 8
  %5 = getelementptr inbounds %class.OutputStream, %class.OutputStream* %4, i32 0, i32 1
...
; Function Attrs: noinline optnone uwtable
define void @_ZN12OutputStream12setSumWeightENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(%class.OutputStream*, %"class.std::__cxx11::basic_string"*) #4 align 2 {
  %3 = alloca %class.OutputStream*, align 8
  store %class.OutputStream* %0, %class.OutputStream** %3, align 8
  %4 = load %class.OutputStream*, %class.OutputStream** %3, align 8
  %5 = getelementptr inbounds %class.OutputStream, %class.OutputStream* %4, i32 0, i32 1
  ...
  %7 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.4, i32 0, i32 0))
  ...
  %9 = getelementptr inbounds %class.OutputStream, %class.OutputStream* %4, i32 0, i32 1
