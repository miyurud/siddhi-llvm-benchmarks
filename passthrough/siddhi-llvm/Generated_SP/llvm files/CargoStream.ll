; ModuleID = 'CargoStream.cpp'
source_filename = "CargoStream.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_CargoStream.cpp, i8* null }]
