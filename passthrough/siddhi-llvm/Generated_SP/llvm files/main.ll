...
%class.ExampleRebalanceCb = type { %"class.RdKafka::RebalanceCb" }
%"class.RdKafka::RebalanceCb" = type { i32 (...)** }
%class.ExampleEventCb = type { %"class.RdKafka::EventCb" }
%"class.RdKafka::EventCb" = type { i32 (...)** }
%"class.RdKafka::KafkaConsumer" = type { %"class.RdKafka::Handle" }
%"class.RdKafka::Handle" = type { i32 (...)** }
%"class.RdKafka::Message" = type { i32 (...)** }
...
%"struct.std::_Vector_base<RdKafka::TopicPartition *, std::allocator<RdKafka::TopicPartition *> >::_Vector_impl" = type { %"class.RdKafka::TopicPartition"**, %"class.RdKafka::TopicPartition"**, %"class.RdKafka::TopicPartition"** }
%"class.RdKafka::TopicPartition" = type { i32 (...)** }
%"class.RdKafka::Event" = type { i32 (...)** }
...
@.str = private unnamed_addr constant [6 x i8] c"test4\00", align 1
...
@.str.10 = private unnamed_addr constant [10 x i8] c"beginning\00", align 1
...
@_ZTVN7RdKafka11RebalanceCbE = linkonce_odr unnamed_addr constant { [5 x i8*] } { [5 x i8*] [i8* null, i8* bitcast ({ i8*, i8* }* @_ZTIN7RdKafka11RebalanceCbE to i8*), i8* bitcast (void ()* @__cxa_pure_virtual to i8*), i8* bitcast (void (%"class.RdKafka::RebalanceCb"*)* @_ZN7RdKafka11RebalanceCbD2Ev to i8*), i8* bitcast (void (%"class.RdKafka::RebalanceCb"*)* @_ZN7RdKafka11RebalanceCbD0Ev to i8*)] }, comdat, align 8
...
@_ZTV14ExampleEventCb = linkonce_odr unnamed_addr constant { [5 x i8*] } { [5 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI14ExampleEventCb to i8*), i8* bitcast (void (%class.ExampleEventCb*, %"class.RdKafka::Event"*)* @_ZN14ExampleEventCb8event_cbERN7RdKafka5EventE to i8*), i8* bitcast (void (%class.ExampleEventCb*)* @_ZN14ExampleEventCbD2Ev to i8*), i8* bitcast (void (%class.ExampleEventCb*)* @_ZN14ExampleEventCbD0Ev to i8*)] }, comdat, align 8
...
@_ZTVN7RdKafka7EventCbE = linkonce_odr unnamed_addr constant { [5 x i8*] } { [5 x i8*] [i8* null, i8* bitcast ({ i8*, i8* }* @_ZTIN7RdKafka7EventCbE to i8*), i8* bitcast (void ()* @__cxa_pure_virtual to i8*), i8* bitcast (void (%"class.RdKafka::EventCb"*)* @_ZN7RdKafka7EventCbD2Ev to i8*), i8* bitcast (void (%"class.RdKafka::EventCb"*)* @_ZN7RdKafka7EventCbD0Ev to i8*)] }, comdat, align 8
...
define i32 @main() #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %2, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0), %"class.std::allocator.0"* dereferenceable(1) %3)
          to label %10 unwind label %14

; <label>:10:                                     ; preds = %0
  call void @_ZNSaIcEC1Ev(%"class.std::allocator.0"* %7) #3
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %6, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), %"class.std::allocator.0"* dereferenceable(1) %7)
          to label %11 unwind label %18

; <label>:11:                                     ; preds = %10
  call void @_ZNSaIcEC1Ev(%"class.std::allocator.0"* %9) #3
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %8, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i32 0, i32 0), %"class.std::allocator.0"* dereferenceable(1) %9)
...
define linkonce_odr void @_ZN8ConsumerC2Ev(%class.Consumer*) unnamed_addr #5 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr void @_ZN8Consumer13start_consumeENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_S5_(%class.Consumer*, %"class.std::__cxx11::basic_string"*, %"class.std::__cxx11::basic_string"*, %"class.std::__cxx11::basic_string"*) #5 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %21 = alloca %class.ExampleEventCb, align 8
  ...
  %30 = alloca %"class.RdKafka::KafkaConsumer"*, align 8
  %31 = alloca %"class.std::__cxx11::basic_string", align 8
  %32 = alloca i32, align 4
  %33 = alloca %"class.std::__cxx11::basic_string", align 8
  %34 = alloca %"class.RdKafka::Message"*, align 8
  ...
  %40 = bitcast %"class.RdKafka::Conf"* %39 to i32 (%"class.RdKafka::Conf"*, %"class.std::__cxx11::basic_string"*, %"class.RdKafka::RebalanceCb"*, %"class.std::__cxx11::basic_string"*)***
  %41 = load i32 (%"class.RdKafka::Conf"*, %"class.std::__cxx11::basic_string"*, %"class.RdKafka::RebalanceCb"*, %"class.std::__cxx11::basic_string"*)**, i32 (%"class.RdKafka::Conf"*, %"class.std::__cxx11::basic_string"*, %"class.RdKafka::RebalanceCb"*, %"class.std::__cxx11::basic_string"*)*** %40, align 8
  %42 = getelementptr inbounds i32 (%"class.RdKafka::Conf"*, %"class.std::__cxx11::basic_string"*, %"class.RdKafka::RebalanceCb"*, %"class.std::__cxx11::basic_string"*)*, i32 (%"class.RdKafka::Conf"*, %"class.std::__cxx11::basic_string"*, %"class.RdKafka::RebalanceCb"*, %"class.std::__cxx11::basic_string"*)** %41, i64 10
  %43 = load i32 (%"class.RdKafka::Conf"*, %"class.std::__cxx11::basic_string"*, %"class.RdKafka::RebalanceCb"*, %"class.std::__cxx11::basic_string"*)*, i32 (%"class.RdKafka::Conf"*, %"class.std::__cxx11::basic_string"*, %"class.RdKafka::RebalanceCb"*, %"class.std::__cxx11::basic_string"*)** %42, align 8
  call void @_ZNSaIcEC1Ev(%"class.std::allocator.0"* %10) #3
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %9, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.3, i32 0, i32 0), %"class.std::allocator.0"* dereferenceable(1) %10)
          to label %44 unwind label %75

; <label>:44:                                     ; preds = %4
  %45 = bitcast %class.ExampleRebalanceCb* %8 to %"class.RdKafka::RebalanceCb"*
  %46 = getelementptr inbounds %class.Consumer, %class.Consumer* %35, i32 0, i32 1
  %47 = invoke i32 %43(%"class.RdKafka::Conf"* %39, %"class.std::__cxx11::basic_string"* dereferenceable(32) %9, %"class.RdKafka::RebalanceCb"* %45, %"class.std::__cxx11::basic_string"* dereferenceable(32) %46)
...
; <label>:48:                                     ; preds = %44
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %13, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.4, i32 0, i32 0), %"class.std::allocator.0"* dereferenceable(1) %14)
          to label %54 unwind label %84

; <label>:54:                                     ; preds = %48
  call void @_ZNSaIcEC1Ev(%"class.std::allocator.0"* %16) #3
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %15, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.5, i32 0, i32 0), %"class.std::allocator.0"* dereferenceable(1) %16)
...
; <label>:58:                                     ; preds = %55
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %17, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.6, i32 0, i32 0), %"class.std::allocator.0"* dereferenceable(1) %18)
...
; <label>:111:                                    ; preds = %74, %67
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %19, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.7, i32 0, i32 0), %"class.std::allocator.0"* dereferenceable(1) %20)
...
; <label>:120:                                    ; preds = %117
  ...
  call void @_ZN14ExampleEventCbC2Ev(%class.ExampleEventCb* %21) #3
  %121 = load %"class.RdKafka::Conf"*, %"class.RdKafka::Conf"** %6, align 8
  %122 = bitcast %"class.RdKafka::Conf"* %121 to i32 (%"class.RdKafka::Conf"*, %"class.std::__cxx11::basic_string"*, %"class.RdKafka::EventCb"*, %"class.std::__cxx11::basic_string"*)***
  %123 = load i32 (%"class.RdKafka::Conf"*, %"class.std::__cxx11::basic_string"*, %"class.RdKafka::EventCb"*, %"class.std::__cxx11::basic_string"*)**, i32 (%"class.RdKafka::Conf"*, %"class.std::__cxx11::basic_string"*, %"class.RdKafka::EventCb"*, %"class.std::__cxx11::basic_string"*)*** %122, align 8
  %124 = getelementptr inbounds i32 (%"class.RdKafka::Conf"*, %"class.std::__cxx11::basic_string"*, %"class.RdKafka::EventCb"*, %"class.std::__cxx11::basic_string"*)*, i32 (%"class.RdKafka::Conf"*, %"class.std::__cxx11::basic_string"*, %"class.RdKafka::EventCb"*, %"class.std::__cxx11::basic_string"*)** %123, i64 4
  %125 = load i32 (%"class.RdKafka::Conf"*, %"class.std::__cxx11::basic_string"*, %"class.RdKafka::EventCb"*, %"class.std::__cxx11::basic_string"*)*, i32 (%"class.RdKafka::Conf"*, %"class.std::__cxx11::basic_string"*, %"class.RdKafka::EventCb"*, %"class.std::__cxx11::basic_string"*)** %124, align 8
  call void @_ZNSaIcEC1Ev(%"class.std::allocator.0"* %23) #3
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %22, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.8, i32 0, i32 0), %"class.std::allocator.0"* dereferenceable(1) %23)
          to label %126 unwind label %184

; <label>:126:                                    ; preds = %120
  %127 = bitcast %class.ExampleEventCb* %21 to %"class.RdKafka::EventCb"*
  %128 = getelementptr inbounds %class.Consumer, %class.Consumer* %35, i32 0, i32 1
  %129 = invoke i32 %125(%"class.RdKafka::Conf"* %121, %"class.std::__cxx11::basic_string"* dereferenceable(32) %22, %"class.RdKafka::EventCb"* %127, %"class.std::__cxx11::basic_string"* dereferenceable(32) %128)
...
; <label>:130:                                    ; preds = %126
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %24, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.9, i32 0, i32 0), %"class.std::allocator.0"* dereferenceable(1) %25)
          to label %136 unwind label %193

; <label>:136:                                    ; preds = %130
  call void @_ZNSaIcEC1Ev(%"class.std::allocator.0"* %27) #3
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %26, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.10, i32 0, i32 0), %"class.std::allocator.0"* dereferenceable(1) %27)
...
; <label>:140:                                    ; preds = %137
  ...
  call void @_ZNSaIcED1Ev(%"class.std::allocator.0"* %27) #3
  ...
  call void @_ZNSaIcEC1Ev(%"class.std::allocator.0"* %29) #3
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %28, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.11, i32 0, i32 0), %"class.std::allocator.0"* dereferenceable(1) %29)
...
; <label>:150:                                    ; preds = %146
  ...
  call void @_ZNSaIcED1Ev(%"class.std::allocator.0"* %29) #3
...
; <label>:158:                                    ; preds = %153, %150
  ...
  %163 = invoke %"class.RdKafka::KafkaConsumer"* @_ZN7RdKafka13KafkaConsumer6createEPNS_4ConfERNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(%"class.RdKafka::Conf"* %161, %"class.std::__cxx11::basic_string"* dereferenceable(32) %162)
          to label %164 unwind label %216

; <label>:164:                                    ; preds = %158
  store %"class.RdKafka::KafkaConsumer"* %163, %"class.RdKafka::KafkaConsumer"** %30, align 8
  %165 = load %"class.RdKafka::KafkaConsumer"*, %"class.RdKafka::KafkaConsumer"** %30, align 8
  %166 = icmp ne %"class.RdKafka::KafkaConsumer"* %165, null
...
; <label>:230:                                    ; preds = %228
  %231 = load %"class.RdKafka::KafkaConsumer"*, %"class.RdKafka::KafkaConsumer"** %30, align 8
  %232 = bitcast %"class.RdKafka::KafkaConsumer"* %231 to i8**
  %233 = load i8*, i8** %232, align 8
  %234 = getelementptr i8, i8* %233, i64 -168
  %235 = bitcast i8* %234 to i64*
  %236 = load i64, i64* %235, align 8
  %237 = bitcast %"class.RdKafka::KafkaConsumer"* %231 to i8*
  %238 = getelementptr inbounds i8, i8* %237, i64 %236
  %239 = bitcast i8* %238 to %"class.RdKafka::Handle"*
  %240 = bitcast %"class.RdKafka::Handle"* %239 to void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Handle"*)***
  %241 = load void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Handle"*)**, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Handle"*)*** %240, align 8
  %242 = getelementptr inbounds void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Handle"*)*, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Handle"*)** %241, i64 2
  %243 = load void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Handle"*)*, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Handle"*)** %242, align 8
  invoke void %243(%"class.std::__cxx11::basic_string"* sret %31, %"class.RdKafka::Handle"* %239)
...
; <label>:248:                                    ; preds = %246
  ...
  %249 = load %"class.RdKafka::KafkaConsumer"*, %"class.RdKafka::KafkaConsumer"** %30, align 8
  %250 = bitcast %"class.RdKafka::KafkaConsumer"* %249 to i32 (%"class.RdKafka::KafkaConsumer"*, %"class.std::vector"*)***
  %251 = load i32 (%"class.RdKafka::KafkaConsumer"*, %"class.std::vector"*)**, i32 (%"class.RdKafka::KafkaConsumer"*, %"class.std::vector"*)*** %250, align 8
  %252 = getelementptr inbounds i32 (%"class.RdKafka::KafkaConsumer"*, %"class.std::vector"*)*, i32 (%"class.RdKafka::KafkaConsumer"*, %"class.std::vector"*)** %251, i64 21
  %253 = load i32 (%"class.RdKafka::KafkaConsumer"*, %"class.std::vector"*)*, i32 (%"class.RdKafka::KafkaConsumer"*, %"class.std::vector"*)** %252, align 8
  %254 = getelementptr inbounds %class.Consumer, %class.Consumer* %35, i32 0, i32 3
  %255 = invoke i32 %253(%"class.RdKafka::KafkaConsumer"* %249, %"class.std::vector"* dereferenceable(24) %254)
...
; <label>:286:                                    ; preds = %283
  %287 = load %"class.RdKafka::KafkaConsumer"*, %"class.RdKafka::KafkaConsumer"** %30, align 8
  %288 = bitcast %"class.RdKafka::KafkaConsumer"* %287 to %"class.RdKafka::Message"* (%"class.RdKafka::KafkaConsumer"*, i32)***
  %289 = load %"class.RdKafka::Message"* (%"class.RdKafka::KafkaConsumer"*, i32)**, %"class.RdKafka::Message"* (%"class.RdKafka::KafkaConsumer"*, i32)*** %288, align 8
  %290 = getelementptr inbounds %"class.RdKafka::Message"* (%"class.RdKafka::KafkaConsumer"*, i32)*, %"class.RdKafka::Message"* (%"class.RdKafka::KafkaConsumer"*, i32)** %289, i64 25
  %291 = load %"class.RdKafka::Message"* (%"class.RdKafka::KafkaConsumer"*, i32)*, %"class.RdKafka::Message"* (%"class.RdKafka::KafkaConsumer"*, i32)** %290, align 8
  %292 = invoke %"class.RdKafka::Message"* %291(%"class.RdKafka::KafkaConsumer"* %287, i32 1000)
          to label %293 unwind label %216

; <label>:293:                                    ; preds = %286
  store %"class.RdKafka::Message"* %292, %"class.RdKafka::Message"** %34, align 8
  %294 = load %"class.RdKafka::Message"*, %"class.RdKafka::Message"** %34, align 8
  invoke void @_ZN8Consumer11msg_consumeEPN7RdKafka7MessageEPv(%class.Consumer* %35, %"class.RdKafka::Message"* %294, i8* null)
          to label %295 unwind label %216

; <label>:295:                                    ; preds = %293
  %296 = load %"class.RdKafka::Message"*, %"class.RdKafka::Message"** %34, align 8
  %297 = icmp eq %"class.RdKafka::Message"* %296, null
  br i1 %297, label %303, label %298

; <label>:298:                                    ; preds = %295
  %299 = bitcast %"class.RdKafka::Message"* %296 to void (%"class.RdKafka::Message"*)***
  %300 = load void (%"class.RdKafka::Message"*)**, void (%"class.RdKafka::Message"*)*** %299, align 8
  %301 = getelementptr inbounds void (%"class.RdKafka::Message"*)*, void (%"class.RdKafka::Message"*)** %300, i64 14
  %302 = load void (%"class.RdKafka::Message"*)*, void (%"class.RdKafka::Message"*)** %301, align 8
  call void %302(%"class.RdKafka::Message"* %296) #3
  br label %303
...
; <label>:304:                                    ; preds = %283
  %305 = load %"class.RdKafka::KafkaConsumer"*, %"class.RdKafka::KafkaConsumer"** %30, align 8
  %306 = bitcast %"class.RdKafka::KafkaConsumer"* %305 to i32 (%"class.RdKafka::KafkaConsumer"*)***
  %307 = load i32 (%"class.RdKafka::KafkaConsumer"*)**, i32 (%"class.RdKafka::KafkaConsumer"*)*** %306, align 8
  %308 = getelementptr inbounds i32 (%"class.RdKafka::KafkaConsumer"*)*, i32 (%"class.RdKafka::KafkaConsumer"*)** %307, i64 36
  %309 = load i32 (%"class.RdKafka::KafkaConsumer"*)*, i32 (%"class.RdKafka::KafkaConsumer"*)** %308, align 8
  %310 = invoke i32 %309(%"class.RdKafka::KafkaConsumer"* %305)
          to label %311 unwind label %216

; <label>:311:                                    ; preds = %304
  %312 = load %"class.RdKafka::KafkaConsumer"*, %"class.RdKafka::KafkaConsumer"** %30, align 8
  %313 = icmp eq %"class.RdKafka::KafkaConsumer"* %312, null
  br i1 %313, label %319, label %314

; <label>:314:                                    ; preds = %311
  %315 = bitcast %"class.RdKafka::KafkaConsumer"* %312 to void (%"class.RdKafka::KafkaConsumer"*)***
  %316 = load void (%"class.RdKafka::KafkaConsumer"*)**, void (%"class.RdKafka::KafkaConsumer"*)*** %315, align 8
  %317 = getelementptr inbounds void (%"class.RdKafka::KafkaConsumer"*)*, void (%"class.RdKafka::KafkaConsumer"*)** %316, i64 1
  %318 = load void (%"class.RdKafka::KafkaConsumer"*)*, void (%"class.RdKafka::KafkaConsumer"*)** %317, align 8
  call void %318(%"class.RdKafka::KafkaConsumer"* %312) #3
  br label %319
...
; <label>:335:                                    ; preds = %333
  call void @_ZN14ExampleEventCbD2Ev(%class.ExampleEventCb* %21) #3
...
define linkonce_odr void @_ZN8ConsumerD2Ev(%class.Consumer*) unnamed_addr #6 comdat align 2 {
  %2 = alloca %class.Consumer*, align 8
  store %class.Consumer* %0, %class.Consumer** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EEC2Ev(%"class.std::vector"*) unnamed_addr #6 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
...
declare void @_ZN9ExecutionC1Ev(%class.Execution*) unnamed_addr #1
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr void @_ZNSt12_Vector_baseINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EEC2Ev(%"struct.std::_Vector_base"*) unnamed_addr #5 comdat align 2 {
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZNSt12_Vector_baseINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE12_Vector_implC2Ev(%"struct.std::_Vector_base<std::__cxx11::basic_string<char>, std::allocator<std::__cxx11::basic_string<char> > >::_Vector_impl"*) unnamed_addr #6 comdat align 2 {
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr void @_ZSt8_DestroyIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_EvT_S7_RSaIT0_E(%"class.std::__cxx11::basic_string"*, %"class.std::__cxx11::basic_string"*, %"class.std::allocator"* dereferenceable(1)) #5 comdat {
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr void @_ZSt8_DestroyIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvT_S7_(%"class.std::__cxx11::basic_string"*, %"class.std::__cxx11::basic_string"*) #5 comdat {
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr void @_ZNSt12_Destroy_auxILb0EE9__destroyIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEvT_S9_(%"class.std::__cxx11::basic_string"*, %"class.std::__cxx11::basic_string"*) #5 comdat align 2 {
  %3 = alloca %"class.std::__cxx11::basic_string"*, align 8
  %4 = alloca %"class.std::__cxx11::basic_string"*, align 8
  store %"class.std::__cxx11::basic_string"* %0, %"class.std::__cxx11::basic_string"** %3, align 8
  store %"class.std::__cxx11::basic_string"* %1, %"class.std::__cxx11::basic_string"** %4, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr void @_ZNSt12_Vector_baseINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE13_M_deallocateEPS5_m(%"struct.std::_Vector_base"*, %"class.std::__cxx11::basic_string"*, i64) #5 comdat align 2 {
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEE10deallocateERS6_PS5_m(%"class.std::allocator"* dereferenceable(1), %"class.std::__cxx11::basic_string"*, i64) #5 comdat align 2 {
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr void @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE9push_backERKS5_(%"class.std::vector"*, %"class.std::__cxx11::basic_string"* dereferenceable(32)) #5 comdat align 2 {
...
; <label>:16:                                     ; preds = %2
  ...
  call void @_ZNSt16allocator_traitsISaINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEE9constructIS5_JRKS5_EEEvRS6_PT_DpOT0_(%"class.std::allocator"* dereferenceable(1) %19, %"class.std::__cxx11::basic_string"* %23, %"class.std::__cxx11::basic_string"* dereferenceable(32) %24)
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN18ExampleRebalanceCbC2Ev(%class.ExampleRebalanceCb*) unnamed_addr #6 comdat align 2 {
  ...
  %4 = bitcast %class.ExampleRebalanceCb* %3 to %"class.RdKafka::RebalanceCb"*
  call void @_ZN7RdKafka11RebalanceCbC2Ev(%"class.RdKafka::RebalanceCb"* %4) #3
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN14ExampleEventCbC2Ev(%class.ExampleEventCb*) unnamed_addr #6 comdat align 2 {
  %2 = alloca %class.ExampleEventCb*, align 8
  store %class.ExampleEventCb* %0, %class.ExampleEventCb** %2, align 8
  %3 = load %class.ExampleEventCb*, %class.ExampleEventCb** %2, align 8
  %4 = bitcast %class.ExampleEventCb* %3 to %"class.RdKafka::EventCb"*
  call void @_ZN7RdKafka7EventCbC2Ev(%"class.RdKafka::EventCb"* %4) #3
  %5 = bitcast %class.ExampleEventCb* %3 to i32 (...)***
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @_ZL7sigtermi(i32) #6 {
...
declare %"class.RdKafka::KafkaConsumer"* @_ZN7RdKafka13KafkaConsumer6createEPNS_4ConfERNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(%"class.RdKafka::Conf"*, %"class.std::__cxx11::basic_string"* dereferenceable(32)) #1
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr void @_ZN8Consumer11msg_consumeEPN7RdKafka7MessageEPv(%class.Consumer*, %"class.RdKafka::Message"*, i8*) #5 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %class.Consumer*, align 8
  %5 = alloca %"class.RdKafka::Message"*, align 8
  %6 = alloca i8*, align 8
  ...
  store %"class.RdKafka::Message"* %1, %"class.RdKafka::Message"** %5, align 8
  store i8* %2, i8** %6, align 8
  %13 = load %class.Consumer*, %class.Consumer** %4, align 8
  %14 = load %"class.RdKafka::Message"*, %"class.RdKafka::Message"** %5, align 8
  %15 = bitcast %"class.RdKafka::Message"* %14 to i32 (%"class.RdKafka::Message"*)***
  %16 = load i32 (%"class.RdKafka::Message"*)**, i32 (%"class.RdKafka::Message"*)*** %15, align 8
  %17 = getelementptr inbounds i32 (%"class.RdKafka::Message"*)*, i32 (%"class.RdKafka::Message"*)** %16, i64 1
  %18 = load i32 (%"class.RdKafka::Message"*)*, i32 (%"class.RdKafka::Message"*)** %17, align 8
  %19 = call i32 %18(%"class.RdKafka::Message"* %14)
...
; <label>:21:                                     ; preds = %3
  ...
  %24 = load %"class.RdKafka::Message"*, %"class.RdKafka::Message"** %5, align 8
  %25 = bitcast %"class.RdKafka::Message"* %24 to i64 (%"class.RdKafka::Message"*)***
  %26 = load i64 (%"class.RdKafka::Message"*)**, i64 (%"class.RdKafka::Message"*)*** %25, align 8
  %27 = getelementptr inbounds i64 (%"class.RdKafka::Message"*)*, i64 (%"class.RdKafka::Message"*)** %26, i64 6
  %28 = load i64 (%"class.RdKafka::Message"*)*, i64 (%"class.RdKafka::Message"*)** %27, align 8
  %29 = call i64 %28(%"class.RdKafka::Message"* %24)
  %30 = load i64, i64* @_ZL9msg_bytes, align 8
  %31 = add i64 %30, %29
  store i64 %31, i64* @_ZL9msg_bytes, align 8
  %32 = load %"class.RdKafka::Message"*, %"class.RdKafka::Message"** %5, align 8
  %33 = bitcast %"class.RdKafka::Message"* %32 to i8* (%"class.RdKafka::Message"*)***
  %34 = load i8* (%"class.RdKafka::Message"*)**, i8* (%"class.RdKafka::Message"*)*** %33, align 8
  %35 = getelementptr inbounds i8* (%"class.RdKafka::Message"*)*, i8* (%"class.RdKafka::Message"*)** %34, i64 5
  %36 = load i8* (%"class.RdKafka::Message"*)*, i8* (%"class.RdKafka::Message"*)** %35, align 8
  %37 = call i8* %36(%"class.RdKafka::Message"* %32)
  call void @_ZNSaIcEC1Ev(%"class.std::allocator.0"* %8) #3
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %7, i8* %37, %"class.std::allocator.0"* dereferenceable(1) %8)
...
; <label>:64:                                     ; preds = %3, %3
  ...
  %66 = load %"class.RdKafka::Message"*, %"class.RdKafka::Message"** %5, align 8
  %67 = bitcast %"class.RdKafka::Message"* %66 to void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Message"*)***
  %68 = load void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Message"*)**, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Message"*)*** %67, align 8
  %69 = getelementptr inbounds void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Message"*)*, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Message"*)** %68, i64 0
  %70 = load void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Message"*)*, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Message"*)** %69, align 8
  call void %70(%"class.std::__cxx11::basic_string"* sret %11, %"class.RdKafka::Message"* %66)
...
; <label>:79:                                     ; preds = %3
  ...
  %81 = load %"class.RdKafka::Message"*, %"class.RdKafka::Message"** %5, align 8
  %82 = bitcast %"class.RdKafka::Message"* %81 to void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Message"*)***
  %83 = load void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Message"*)**, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Message"*)*** %82, align 8
  %84 = getelementptr inbounds void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Message"*)*, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Message"*)** %83, i64 0
  %85 = load void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Message"*)*, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Message"*)** %84, align 8
  call void %85(%"class.std::__cxx11::basic_string"* sret %12, %"class.RdKafka::Message"* %81)
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN14ExampleEventCbD2Ev(%class.ExampleEventCb*) unnamed_addr #6 comdat align 2 {
  %2 = alloca %class.ExampleEventCb*, align 8
  store %class.ExampleEventCb* %0, %class.ExampleEventCb** %2, align 8
  %3 = load %class.ExampleEventCb*, %class.ExampleEventCb** %2, align 8
  %4 = bitcast %class.ExampleEventCb* %3 to %"class.RdKafka::EventCb"*
  call void @_ZN7RdKafka7EventCbD2Ev(%"class.RdKafka::EventCb"* %4) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN18ExampleRebalanceCbD2Ev(%class.ExampleRebalanceCb*) unnamed_addr #6 comdat align 2 {
  %2 = alloca %class.ExampleRebalanceCb*, align 8
  store %class.ExampleRebalanceCb* %0, %class.ExampleRebalanceCb** %2, align 8
  %3 = load %class.ExampleRebalanceCb*, %class.ExampleRebalanceCb** %2, align 8
  %4 = bitcast %class.ExampleRebalanceCb* %3 to %"class.RdKafka::RebalanceCb"*
  call void @_ZN7RdKafka11RebalanceCbD2Ev(%"class.RdKafka::RebalanceCb"* %4) #3
  ret void
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEE9constructIS5_JRKS5_EEEvRS6_PT_DpOT0_(%"class.std::allocator"* dereferenceable(1), %"class.std::__cxx11::basic_string"*, %"class.std::__cxx11::basic_string"* dereferenceable(32)) #5 comdat align 2 {
  %4 = alloca %"class.std::allocator"*, align 8
  %5 = alloca %"class.std::__cxx11::basic_string"*, align 8
  %6 = alloca %"class.std::__cxx11::basic_string"*, align 8
  store %"class.std::allocator"* %0, %"class.std::allocator"** %4, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr void @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE17_M_realloc_insertIJRKS5_EEEvN9__gnu_cxx17__normal_iteratorIPS5_S7_EEDpOT_(%"class.std::vector"*, %"class.std::__cxx11::basic_string"*, %"class.std::__cxx11::basic_string"* dereferenceable(32)) #5 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt16allocator_traitsISaINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEE9constructIS5_JRKS5_EEEvRS6_PT_DpOT0_(%"class.std::allocator"* dereferenceable(1) %26, %"class.std::__cxx11::basic_string"* %29, %"class.std::__cxx11::basic_string"* dereferenceable(32) %31)
...
; <label>:66:                                     ; preds = %61
  ...
  %69 = bitcast %"struct.std::_Vector_base<std::__cxx11::basic_string<char>, std::allocator<std::__cxx11::basic_string<char> > >::_Vector_impl"* %68 to %"class.std::allocator"*
  ...
  invoke void @_ZNSt16allocator_traitsISaINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEE7destroyIS5_EEvRS6_PT_(%"class.std::allocator"* dereferenceable(1) %69, %"class.std::__cxx11::basic_string"* %72)
...
; <label>:78:                                     ; preds = %61
  ...
  %82 = call dereferenceable(1) %"class.std::allocator"* @_ZNSt12_Vector_baseINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %81) #3
  invoke void @_ZSt8_DestroyIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_EvT_S7_RSaIT0_E(%"class.std::__cxx11::basic_string"* %79, %"class.std::__cxx11::basic_string"* %80, %"class.std::allocator"* dereferenceable(1) %82)
...
; <label>:90:                                     ; preds = %56
  ...
  %100 = call dereferenceable(1) %"class.std::allocator"* @_ZNSt12_Vector_baseINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %99) #3
  call void @_ZSt8_DestroyIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_EvT_S7_RSaIT0_E(%"class.std::__cxx11::basic_string"* %94, %"class.std::__cxx11::basic_string"* %98, %"class.std::allocator"* dereferenceable(1) %100)
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr %"class.std::__cxx11::basic_string"* @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE3endEv(%"class.std::vector"*) #6 comdat align 2 {
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEE9constructIS6_JRKS6_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator"*, %"class.std::__cxx11::basic_string"*, %"class.std::__cxx11::basic_string"* dereferenceable(32)) #5 comdat align 2 {
  %4 = alloca %"class.__gnu_cxx::new_allocator"*, align 8
  %5 = alloca %"class.std::__cxx11::basic_string"*, align 8
  %6 = alloca %"class.std::__cxx11::basic_string"*, align 8
  store %"class.__gnu_cxx::new_allocator"* %0, %"class.__gnu_cxx::new_allocator"** %4, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZSt7forwardIRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEOT_RNSt16remove_referenceIS8_E4typeE(%"class.std::__cxx11::basic_string"* dereferenceable(32)) #6 comdat {
  %2 = alloca %"class.std::__cxx11::basic_string"*, align 8
  store %"class.std::__cxx11::basic_string"* %0, %"class.std::__cxx11::basic_string"** %2, align 8
  %3 = load %"class.std::__cxx11::basic_string"*, %"class.std::__cxx11::basic_string"** %2, align 8
  ret %"class.std::__cxx11::basic_string"* %3
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr i64 @_ZNKSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE12_M_check_lenEmPKc(%"class.std::vector"*, i64, i8*) #5 comdat align 2 {
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i64 @_ZN9__gnu_cxxmiIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt6vectorIS6_SaIS6_EEEENS_17__normal_iteratorIT_T0_E15difference_typeERKSE_SH_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8), %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8)) #6 comdat {
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr %"class.std::__cxx11::basic_string"* @_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE5beginEv(%"class.std::vector"*) #6 comdat align 2 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %3 = alloca %"class.std::vector"*, align 8
  store %"class.std::vector"* %0, %"class.std::vector"** %3, align 8
  %4 = load %"class.std::vector"*, %"class.std::vector"** %3, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr %"class.std::__cxx11::basic_string"* @_ZNSt12_Vector_baseINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE11_M_allocateEm(%"struct.std::_Vector_base"*, i64) #5 comdat align 2 {
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dereferenceable(8) %"class.std::__cxx11::basic_string"** @_ZNK9__gnu_cxx17__normal_iteratorIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt6vectorIS6_SaIS6_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator"*) #6 comdat align 2 {
  %2 = alloca %"class.__gnu_cxx::__normal_iterator"*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEE7destroyIS5_EEvRS6_PT_(%"class.std::allocator"* dereferenceable(1), %"class.std::__cxx11::basic_string"*) #5 comdat align 2 {
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i64 @_ZNKSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE8max_sizeEv(%"class.std::vector"*) #6 comdat align 2 {
  %2 = alloca %"class.std::vector"*, align 8
  store %"class.std::vector"* %0, %"class.std::vector"** %2, align 8
  %3 = load %"class.std::vector"*, %"class.std::vector"** %2, align 8
  %4 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i64 @_ZNSt16allocator_traitsISaINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEE8max_sizeERKS6_(%"class.std::allocator"* dereferenceable(1)) #6 comdat align 2 {
  %2 = alloca %"class.std::allocator"*, align 8
  store %"class.std::allocator"* %0, %"class.std::allocator"** %2, align 8
  %3 = load %"class.std::allocator"*, %"class.std::allocator"** %2, align 8
  %4 = bitcast %"class.std::allocator"* %3 to %"class.__gnu_cxx::new_allocator"*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dereferenceable(1) %"class.std::allocator"* @_ZNKSt12_Vector_baseINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"*) #6 comdat align 2 {
  %2 = alloca %"struct.std::_Vector_base"*, align 8
  store %"struct.std::_Vector_base"* %0, %"struct.std::_Vector_base"** %2, align 8
  %3 = load %"struct.std::_Vector_base"*, %"struct.std::_Vector_base"** %2, align 8
  %4 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %3, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN9__gnu_cxx17__normal_iteratorIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt6vectorIS6_SaIS6_EEEC2ERKS7_(%"class.__gnu_cxx::__normal_iterator"*, %"class.std::__cxx11::basic_string"** dereferenceable(8)) unnamed_addr #6 comdat align 2 {
  %3 = alloca %"class.__gnu_cxx::__normal_iterator"*, align 8
  %4 = alloca %"class.std::__cxx11::basic_string"**, align 8
  store %"class.__gnu_cxx::__normal_iterator"* %0, %"class.__gnu_cxx::__normal_iterator"** %3, align 8
  store %"class.std::__cxx11::basic_string"** %1, %"class.std::__cxx11::basic_string"*** %4, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr %"class.std::__cxx11::basic_string"* @_ZNSt16allocator_traitsISaINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEE8allocateERS6_m(%"class.std::allocator"* dereferenceable(1), i64) #5 comdat align 2 {
  %3 = alloca %"class.std::allocator"*, align 8
  %4 = alloca i64, align 8
  store %"class.std::allocator"* %0, %"class.std::allocator"** %3, align 8
  store i64 %1, i64* %4, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr %"class.std::__cxx11::basic_string"* @_ZN9__gnu_cxx13new_allocatorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator"*, i64, i8*) #5 comdat align 2 {
  %4 = alloca %"class.__gnu_cxx::new_allocator"*, align 8
  %5 = alloca i64, align 8
  %6 = alloca i8*, align 8
  store %"class.__gnu_cxx::new_allocator"* %0, %"class.__gnu_cxx::new_allocator"** %4, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr %"class.std::__cxx11::basic_string"* @_ZSt32__make_move_if_noexcept_iteratorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt13move_iteratorIPS5_EET0_PT_(%"class.std::__cxx11::basic_string"*) #5 comdat {
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr %"class.std::__cxx11::basic_string"* @_ZSt18uninitialized_copyISt13move_iteratorIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEES7_ET0_T_SA_S9_(%"class.std::__cxx11::basic_string"*, %"class.std::__cxx11::basic_string"*, %"class.std::__cxx11::basic_string"*) #5 comdat {
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr zeroext i1 @_ZStneIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEbRKSt13move_iteratorIT_ESB_(%"class.std::move_iterator"* dereferenceable(8), %"class.std::move_iterator"* dereferenceable(8)) #5 comdat {
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZNKSt13move_iteratorIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEdeEv(%"class.std::move_iterator"*) #6 comdat align 2 {
  %2 = alloca %"class.std::move_iterator"*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dereferenceable(8) %"class.std::move_iterator"* @_ZNSt13move_iteratorIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEppEv(%"class.std::move_iterator"*) #6 comdat align 2 {
  %2 = alloca %"class.std::move_iterator"*, align 8
  store %"class.std::move_iterator"* %0, %"class.std::move_iterator"** %2, align 8
  %3 = load %"class.std::move_iterator"*, %"class.std::move_iterator"** %2, align 8
  %4 = getelementptr inbounds %"class.std::move_iterator", %"class.std::move_iterator"* %3, i32 0, i32 0
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr zeroext i1 @_ZSteqIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEbRKSt13move_iteratorIT_ESB_(%"class.std::move_iterator"* dereferenceable(8), %"class.std::move_iterator"* dereferenceable(8)) #5 comdat {
  %3 = alloca %"class.std::move_iterator"*, align 8
  %4 = alloca %"class.std::move_iterator"*, align 8
  store %"class.std::move_iterator"* %0, %"class.std::move_iterator"** %3, align 8
  store %"class.std::move_iterator"* %1, %"class.std::move_iterator"** %4, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr %"class.std::__cxx11::basic_string"* @_ZNKSt13move_iteratorIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEE4baseEv(%"class.std::move_iterator"*) #6 comdat align 2 {
  %2 = alloca %"class.std::move_iterator"*, align 8
  store %"class.std::move_iterator"* %0, %"class.std::move_iterator"** %2, align 8
  %3 = load %"class.std::move_iterator"*, %"class.std::move_iterator"** %2, align 8
  %4 = getelementptr inbounds %"class.std::move_iterator", %"class.std::move_iterator"* %3, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZNSt13move_iteratorIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEC2ES6_(%"class.std::move_iterator"*, %"class.std::__cxx11::basic_string"*) unnamed_addr #6 comdat align 2 {
  %3 = alloca %"class.std::move_iterator"*, align 8
  %4 = alloca %"class.std::__cxx11::basic_string"*, align 8
  store %"class.std::move_iterator"* %0, %"class.std::move_iterator"** %3, align 8
  store %"class.std::__cxx11::basic_string"* %1, %"class.std::__cxx11::basic_string"** %4, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEE7destroyIS6_EEvPT_(%"class.__gnu_cxx::new_allocator"*, %"class.std::__cxx11::basic_string"*) #6 comdat align 2 {
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN7RdKafka11RebalanceCbC2Ev(%"class.RdKafka::RebalanceCb"*) unnamed_addr #6 comdat align 2 {
  %2 = alloca %"class.RdKafka::RebalanceCb"*, align 8
  store %"class.RdKafka::RebalanceCb"* %0, %"class.RdKafka::RebalanceCb"** %2, align 8
  %3 = load %"class.RdKafka::RebalanceCb"*, %"class.RdKafka::RebalanceCb"** %2, align 8
  %4 = bitcast %"class.RdKafka::RebalanceCb"* %3 to i32 (...)***
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr void @_ZN18ExampleRebalanceCb12rebalance_cbEPN7RdKafka13KafkaConsumerENS0_9ErrorCodeERSt6vectorIPNS0_14TopicPartitionESaIS6_EE(%class.ExampleRebalanceCb*, %"class.RdKafka::KafkaConsumer"*, i32, %"class.std::vector.3"* dereferenceable(24)) unnamed_addr #5 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %5 = alloca %class.ExampleRebalanceCb*, align 8
  %6 = alloca %"class.RdKafka::KafkaConsumer"*, align 8
  ...
  store %"class.RdKafka::KafkaConsumer"* %1, %"class.RdKafka::KafkaConsumer"** %6, align 8
...
; <label>:22:                                     ; preds = %18
  %23 = load %"class.RdKafka::KafkaConsumer"*, %"class.RdKafka::KafkaConsumer"** %6, align 8
  %24 = bitcast %"class.RdKafka::KafkaConsumer"* %23 to i32 (%"class.RdKafka::KafkaConsumer"*, %"class.std::vector.3"*)***
  %25 = load i32 (%"class.RdKafka::KafkaConsumer"*, %"class.std::vector.3"*)**, i32 (%"class.RdKafka::KafkaConsumer"*, %"class.std::vector.3"*)*** %24, align 8
  %26 = getelementptr inbounds i32 (%"class.RdKafka::KafkaConsumer"*, %"class.std::vector.3"*)*, i32 (%"class.RdKafka::KafkaConsumer"*, %"class.std::vector.3"*)** %25, i64 23
  %27 = load i32 (%"class.RdKafka::KafkaConsumer"*, %"class.std::vector.3"*)*, i32 (%"class.RdKafka::KafkaConsumer"*, %"class.std::vector.3"*)** %26, align 8
  %28 = load %"class.std::vector.3"*, %"class.std::vector.3"** %8, align 8
  %29 = call i32 %27(%"class.RdKafka::KafkaConsumer"* %23, %"class.std::vector.3"* dereferenceable(24) %28)
...
; <label>:37:                                     ; preds = %18
  %38 = load %"class.RdKafka::KafkaConsumer"*, %"class.RdKafka::KafkaConsumer"** %6, align 8
  %39 = bitcast %"class.RdKafka::KafkaConsumer"* %38 to i32 (%"class.RdKafka::KafkaConsumer"*)***
  %40 = load i32 (%"class.RdKafka::KafkaConsumer"*)**, i32 (%"class.RdKafka::KafkaConsumer"*)*** %39, align 8
  %41 = getelementptr inbounds i32 (%"class.RdKafka::KafkaConsumer"*)*, i32 (%"class.RdKafka::KafkaConsumer"*)** %40, i64 24
  %42 = load i32 (%"class.RdKafka::KafkaConsumer"*)*, i32 (%"class.RdKafka::KafkaConsumer"*)** %41, align 8
  %43 = call i32 %42(%"class.RdKafka::KafkaConsumer"* %38)
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN18ExampleRebalanceCbD0Ev(%class.ExampleRebalanceCb*) unnamed_addr #6 comdat align 2 {
  %2 = alloca %class.ExampleRebalanceCb*, align 8
  store %class.ExampleRebalanceCb* %0, %class.ExampleRebalanceCb** %2, align 8
  %3 = load %class.ExampleRebalanceCb*, %class.ExampleRebalanceCb** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN7RdKafka11RebalanceCbD2Ev(%"class.RdKafka::RebalanceCb"*) unnamed_addr #6 comdat align 2 {
  %2 = alloca %"class.RdKafka::RebalanceCb"*, align 8
  store %"class.RdKafka::RebalanceCb"* %0, %"class.RdKafka::RebalanceCb"** %2, align 8
  %3 = load %"class.RdKafka::RebalanceCb"*, %"class.RdKafka::RebalanceCb"** %2, align 8
  ret void
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN7RdKafka11RebalanceCbD0Ev(%"class.RdKafka::RebalanceCb"*) unnamed_addr #6 comdat align 2 {
  %2 = alloca %"class.RdKafka::RebalanceCb"*, align 8
  store %"class.RdKafka::RebalanceCb"* %0, %"class.RdKafka::RebalanceCb"** %2, align 8
  %3 = load %"class.RdKafka::RebalanceCb"*, %"class.RdKafka::RebalanceCb"** %2, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr void @_ZN18ExampleRebalanceCb15part_list_printERKSt6vectorIPN7RdKafka14TopicPartitionESaIS3_EE(%"class.std::vector.3"* dereferenceable(24)) #5 comdat align 2 {
...
; <label>:10:                                     ; preds = %4
  ...
  %14 = call dereferenceable(8) %"class.RdKafka::TopicPartition"** @_ZNKSt6vectorIPN7RdKafka14TopicPartitionESaIS2_EEixEm(%"class.std::vector.3"* %11, i64 %13) #3
  %15 = load %"class.RdKafka::TopicPartition"*, %"class.RdKafka::TopicPartition"** %14, align 8
  %16 = bitcast %"class.RdKafka::TopicPartition"* %15 to %"class.std::__cxx11::basic_string"* (%"class.RdKafka::TopicPartition"*)***
  %17 = load %"class.std::__cxx11::basic_string"* (%"class.RdKafka::TopicPartition"*)**, %"class.std::__cxx11::basic_string"* (%"class.RdKafka::TopicPartition"*)*** %16, align 8
  %18 = getelementptr inbounds %"class.std::__cxx11::basic_string"* (%"class.RdKafka::TopicPartition"*)*, %"class.std::__cxx11::basic_string"* (%"class.RdKafka::TopicPartition"*)** %17, i64 2
  %19 = load %"class.std::__cxx11::basic_string"* (%"class.RdKafka::TopicPartition"*)*, %"class.std::__cxx11::basic_string"* (%"class.RdKafka::TopicPartition"*)** %18, align 8
  %20 = call dereferenceable(32) %"class.std::__cxx11::basic_string"* %19(%"class.RdKafka::TopicPartition"* %15)
  ...
  %26 = call dereferenceable(8) %"class.RdKafka::TopicPartition"** @_ZNKSt6vectorIPN7RdKafka14TopicPartitionESaIS2_EEixEm(%"class.std::vector.3"* %23, i64 %25) #3
  %27 = load %"class.RdKafka::TopicPartition"*, %"class.RdKafka::TopicPartition"** %26, align 8
  %28 = bitcast %"class.RdKafka::TopicPartition"* %27 to i32 (%"class.RdKafka::TopicPartition"*)***
  %29 = load i32 (%"class.RdKafka::TopicPartition"*)**, i32 (%"class.RdKafka::TopicPartition"*)*** %28, align 8
  %30 = getelementptr inbounds i32 (%"class.RdKafka::TopicPartition"*)*, i32 (%"class.RdKafka::TopicPartition"*)** %29, i64 3
  %31 = load i32 (%"class.RdKafka::TopicPartition"*)*, i32 (%"class.RdKafka::TopicPartition"*)** %30, align 8
  %32 = call i32 %31(%"class.RdKafka::TopicPartition"* %27)
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i64 @_ZNKSt6vectorIPN7RdKafka14TopicPartitionESaIS2_EE4sizeEv(%"class.std::vector.3"*) #6 comdat align 2 {
  %2 = alloca %"class.std::vector.3"*, align 8
  store %"class.std::vector.3"* %0, %"class.std::vector.3"** %2, align 8
  ...
  %7 = load %"class.RdKafka::TopicPartition"**, %"class.RdKafka::TopicPartition"*** %6, align 8
  ...
  %11 = load %"class.RdKafka::TopicPartition"**, %"class.RdKafka::TopicPartition"*** %10, align 8
  %12 = ptrtoint %"class.RdKafka::TopicPartition"** %7 to i64
  %13 = ptrtoint %"class.RdKafka::TopicPartition"** %11 to i64
  %14 = sub i64 %12, %13
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dereferenceable(8) %"class.RdKafka::TopicPartition"** @_ZNKSt6vectorIPN7RdKafka14TopicPartitionESaIS2_EEixEm(%"class.std::vector.3"*, i64) #6 comdat align 2 {
  ...
  %9 = load %"class.RdKafka::TopicPartition"**, %"class.RdKafka::TopicPartition"*** %8, align 8
  %10 = load i64, i64* %4, align 8
  %11 = getelementptr inbounds %"class.RdKafka::TopicPartition"*, %"class.RdKafka::TopicPartition"** %9, i64 %10
  ret %"class.RdKafka::TopicPartition"** %11
}

declare dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"*, i32) #1

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN7RdKafka7EventCbC2Ev(%"class.RdKafka::EventCb"*) unnamed_addr #6 comdat align 2 {
  %2 = alloca %"class.RdKafka::EventCb"*, align 8
  store %"class.RdKafka::EventCb"* %0, %"class.RdKafka::EventCb"** %2, align 8
  %3 = load %"class.RdKafka::EventCb"*, %"class.RdKafka::EventCb"** %2, align 8
  %4 = bitcast %"class.RdKafka::EventCb"* %3 to i32 (...)***
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr void @_ZN14ExampleEventCb8event_cbERN7RdKafka5EventE(%class.ExampleEventCb*, %"class.RdKafka::Event"* dereferenceable(8)) unnamed_addr #5 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %3 = alloca %class.ExampleEventCb*, align 8
  %4 = alloca %"class.RdKafka::Event"*, align 8
  %5 = alloca %"class.std::__cxx11::basic_string", align 8
  %6 = alloca i8*
  %7 = alloca i32
  %8 = alloca %"class.std::__cxx11::basic_string", align 8
  ...
  store %class.ExampleEventCb* %0, %class.ExampleEventCb** %3, align 8
  store %"class.RdKafka::Event"* %1, %"class.RdKafka::Event"** %4, align 8
  %15 = load %class.ExampleEventCb*, %class.ExampleEventCb** %3, align 8
  %16 = load %"class.RdKafka::Event"*, %"class.RdKafka::Event"** %4, align 8
  %17 = bitcast %"class.RdKafka::Event"* %16 to i32 (%"class.RdKafka::Event"*)***
  %18 = load i32 (%"class.RdKafka::Event"*)**, i32 (%"class.RdKafka::Event"*)*** %17, align 8
  %19 = getelementptr inbounds i32 (%"class.RdKafka::Event"*)*, i32 (%"class.RdKafka::Event"*)** %18, i64 2
  %20 = load i32 (%"class.RdKafka::Event"*)*, i32 (%"class.RdKafka::Event"*)** %19, align 8
  %21 = call i32 %20(%"class.RdKafka::Event"* %16)
...
; <label>:22:                                     ; preds = %2
  %23 = load %"class.RdKafka::Event"*, %"class.RdKafka::Event"** %4, align 8
  %24 = bitcast %"class.RdKafka::Event"* %23 to i1 (%"class.RdKafka::Event"*)***
  %25 = load i1 (%"class.RdKafka::Event"*)**, i1 (%"class.RdKafka::Event"*)*** %24, align 8
  %26 = getelementptr inbounds i1 (%"class.RdKafka::Event"*)*, i1 (%"class.RdKafka::Event"*)** %25, i64 10
  %27 = load i1 (%"class.RdKafka::Event"*)*, i1 (%"class.RdKafka::Event"*)** %26, align 8
  %28 = call zeroext i1 %27(%"class.RdKafka::Event"* %23)
...
; <label>:31:                                     ; preds = %29, %22
  ...
  %33 = load %"class.RdKafka::Event"*, %"class.RdKafka::Event"** %4, align 8
  %34 = bitcast %"class.RdKafka::Event"* %33 to i32 (%"class.RdKafka::Event"*)***
  %35 = load i32 (%"class.RdKafka::Event"*)**, i32 (%"class.RdKafka::Event"*)*** %34, align 8
  %36 = getelementptr inbounds i32 (%"class.RdKafka::Event"*)*, i32 (%"class.RdKafka::Event"*)** %35, i64 3
  %37 = load i32 (%"class.RdKafka::Event"*)*, i32 (%"class.RdKafka::Event"*)** %36, align 8
  %38 = call i32 %37(%"class.RdKafka::Event"* %33)
...
; <label>:42:                                     ; preds = %40
  %43 = load %"class.RdKafka::Event"*, %"class.RdKafka::Event"** %4, align 8
  %44 = bitcast %"class.RdKafka::Event"* %43 to void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)***
  %45 = load void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)**, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)*** %44, align 8
  %46 = getelementptr inbounds void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)*, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)** %45, i64 6
  %47 = load void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)*, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)** %46, align 8
  invoke void %47(%"class.std::__cxx11::basic_string"* sret %8, %"class.RdKafka::Event"* %43)
...
; <label>:62:                                     ; preds = %2
  ...
  %64 = load %"class.RdKafka::Event"*, %"class.RdKafka::Event"** %4, align 8
  %65 = bitcast %"class.RdKafka::Event"* %64 to void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)***
  %66 = load void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)**, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)*** %65, align 8
  %67 = getelementptr inbounds void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)*, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)** %66, i64 6
  %68 = load void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)*, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)** %67, align 8
  call void %68(%"class.std::__cxx11::basic_string"* sret %9, %"class.RdKafka::Event"* %64)
...
; <label>:77:                                     ; preds = %2
  ...
  %79 = load %"class.RdKafka::Event"*, %"class.RdKafka::Event"** %4, align 8
  %80 = bitcast %"class.RdKafka::Event"* %79 to i32 (%"class.RdKafka::Event"*)***
  %81 = load i32 (%"class.RdKafka::Event"*)**, i32 (%"class.RdKafka::Event"*)*** %80, align 8
  %82 = getelementptr inbounds i32 (%"class.RdKafka::Event"*)*, i32 (%"class.RdKafka::Event"*)** %81, i64 4
  %83 = load i32 (%"class.RdKafka::Event"*)*, i32 (%"class.RdKafka::Event"*)** %82, align 8
  %84 = call i32 %83(%"class.RdKafka::Event"* %79)
  %85 = load %"class.RdKafka::Event"*, %"class.RdKafka::Event"** %4, align 8
  %86 = bitcast %"class.RdKafka::Event"* %85 to void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)***
  %87 = load void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)**, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)*** %86, align 8
  %88 = getelementptr inbounds void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)*, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)** %87, i64 5
  %89 = load void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)*, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)** %88, align 8
  call void %89(%"class.std::__cxx11::basic_string"* sret %10, %"class.RdKafka::Event"* %85)
  %90 = call i8* @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5c_strEv(%"class.std::__cxx11::basic_string"* %10) #3
  %91 = load %"class.RdKafka::Event"*, %"class.RdKafka::Event"** %4, align 8
  %92 = bitcast %"class.RdKafka::Event"* %91 to void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)***
  %93 = load void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)**, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)*** %92, align 8
  %94 = getelementptr inbounds void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)*, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)** %93, i64 6
  %95 = load void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)*, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)** %94, align 8
  invoke void %95(%"class.std::__cxx11::basic_string"* sret %11, %"class.RdKafka::Event"* %91)
...
; <label>:109:                                    ; preds = %2
  ...
  %111 = load %"class.RdKafka::Event"*, %"class.RdKafka::Event"** %4, align 8
  %112 = bitcast %"class.RdKafka::Event"* %111 to i32 (%"class.RdKafka::Event"*)***
  %113 = load i32 (%"class.RdKafka::Event"*)**, i32 (%"class.RdKafka::Event"*)*** %112, align 8
  %114 = getelementptr inbounds i32 (%"class.RdKafka::Event"*)*, i32 (%"class.RdKafka::Event"*)** %113, i64 7
  %115 = load i32 (%"class.RdKafka::Event"*)*, i32 (%"class.RdKafka::Event"*)** %114, align 8
  %116 = call i32 %115(%"class.RdKafka::Event"* %111)
  ...
  %119 = load %"class.RdKafka::Event"*, %"class.RdKafka::Event"** %4, align 8
  %120 = bitcast %"class.RdKafka::Event"* %119 to void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)***
  %121 = load void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)**, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)*** %120, align 8
  %122 = getelementptr inbounds void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)*, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)** %121, i64 8
  %123 = load void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)*, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)** %122, align 8
  call void %123(%"class.std::__cxx11::basic_string"* sret %12, %"class.RdKafka::Event"* %119)
...
; <label>:127:                                    ; preds = %125
  %128 = load %"class.RdKafka::Event"*, %"class.RdKafka::Event"** %4, align 8
  %129 = bitcast %"class.RdKafka::Event"* %128 to i32 (%"class.RdKafka::Event"*)***
  %130 = load i32 (%"class.RdKafka::Event"*)**, i32 (%"class.RdKafka::Event"*)*** %129, align 8
  %131 = getelementptr inbounds i32 (%"class.RdKafka::Event"*)*, i32 (%"class.RdKafka::Event"*)** %130, i64 9
  %132 = load i32 (%"class.RdKafka::Event"*)*, i32 (%"class.RdKafka::Event"*)** %131, align 8
  %133 = invoke i32 %132(%"class.RdKafka::Event"* %128)
...
; <label>:143:                                    ; preds = %2
  ...
  %145 = load %"class.RdKafka::Event"*, %"class.RdKafka::Event"** %4, align 8
  %146 = bitcast %"class.RdKafka::Event"* %145 to i32 (%"class.RdKafka::Event"*)***
  %147 = load i32 (%"class.RdKafka::Event"*)**, i32 (%"class.RdKafka::Event"*)*** %146, align 8
  %148 = getelementptr inbounds i32 (%"class.RdKafka::Event"*)*, i32 (%"class.RdKafka::Event"*)** %147, i64 2
  %149 = load i32 (%"class.RdKafka::Event"*)*, i32 (%"class.RdKafka::Event"*)** %148, align 8
  %150 = call i32 %149(%"class.RdKafka::Event"* %145)
  ...
  %153 = load %"class.RdKafka::Event"*, %"class.RdKafka::Event"** %4, align 8
  %154 = bitcast %"class.RdKafka::Event"* %153 to i32 (%"class.RdKafka::Event"*)***
  %155 = load i32 (%"class.RdKafka::Event"*)**, i32 (%"class.RdKafka::Event"*)*** %154, align 8
  %156 = getelementptr inbounds i32 (%"class.RdKafka::Event"*)*, i32 (%"class.RdKafka::Event"*)** %155, i64 3
  %157 = load i32 (%"class.RdKafka::Event"*)*, i32 (%"class.RdKafka::Event"*)** %156, align 8
  %158 = call i32 %157(%"class.RdKafka::Event"* %153)
...
; <label>:162:                                    ; preds = %160
  %163 = load %"class.RdKafka::Event"*, %"class.RdKafka::Event"** %4, align 8
  %164 = bitcast %"class.RdKafka::Event"* %163 to void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)***
  %165 = load void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)**, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)*** %164, align 8
  %166 = getelementptr inbounds void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)*, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)** %165, i64 6
  %167 = load void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)*, void (%"class.std::__cxx11::basic_string"*, %"class.RdKafka::Event"*)** %166, align 8
  invoke void %167(%"class.std::__cxx11::basic_string"* sret %14, %"class.RdKafka::Event"* %163)
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN14ExampleEventCbD0Ev(%class.ExampleEventCb*) unnamed_addr #6 comdat align 2 {
  %2 = alloca %class.ExampleEventCb*, align 8
  store %class.ExampleEventCb* %0, %class.ExampleEventCb** %2, align 8
  %3 = load %class.ExampleEventCb*, %class.ExampleEventCb** %2, align 8
  call void @_ZN14ExampleEventCbD2Ev(%class.ExampleEventCb* %3) #3
  %4 = bitcast %class.ExampleEventCb* %3 to i8*
  call void @_ZdlPv(i8* %4) #15
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN7RdKafka7EventCbD2Ev(%"class.RdKafka::EventCb"*) unnamed_addr #6 comdat align 2 {
  %2 = alloca %"class.RdKafka::EventCb"*, align 8
  store %"class.RdKafka::EventCb"* %0, %"class.RdKafka::EventCb"** %2, align 8
  %3 = load %"class.RdKafka::EventCb"*, %"class.RdKafka::EventCb"** %2, align 8
  ret void
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN7RdKafka7EventCbD0Ev(%"class.RdKafka::EventCb"*) unnamed_addr #6 comdat align 2 {
  %2 = alloca %"class.RdKafka::EventCb"*, align 8
  store %"class.RdKafka::EventCb"* %0, %"class.RdKafka::EventCb"** %2, align 8
  %3 = load %"class.RdKafka::EventCb"*, %"class.RdKafka::EventCb"** %2, align 8
  call void @llvm.trap() #13
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr void @_ZN8Consumer7processENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(%class.Consumer*, %"class.std::__cxx11::basic_string"*) #5 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
...
declare void @_ZN9Execution20setInputSourceWeightENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(%class.Execution*, %"class.std::__cxx11::basic_string"*) #1

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN9ExecutionD2Ev(%class.Execution*) unnamed_addr #6 comdat align 2 {
  ...
  call void @_ZN12OutputStreamD2Ev(%class.OutputStream* %4) #3
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN12OutputStreamD2Ev(%class.OutputStream*) unnamed_addr #6 comdat align 2 {
  %2 = alloca %class.OutputStream*, align 8
  store %class.OutputStream* %0, %class.OutputStream** %2, align 8
  %3 = load %class.OutputStream*, %class.OutputStream** %2, align 8
  %4 = getelementptr inbounds %class.OutputStream, %class.OutputStream* %3, i32 0, i32 1
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %4) #3
  %5 = getelementptr inbounds %class.OutputStream, %class.OutputStream* %3, i32 0, i32 0
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %5) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN11CargoStreamD2Ev(%class.CargoStream*) unnamed_addr #6 comdat align 2 {
